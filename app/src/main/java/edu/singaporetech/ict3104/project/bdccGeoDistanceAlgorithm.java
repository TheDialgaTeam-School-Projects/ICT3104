...
public class bdccGeoDistanceAlgorithm {
    LatLng point;
    List<LatLng> poly;
    public bdccGeoDistanceAlgorithm(Location point, List<LatLng> poly){
        this.point = new LatLng(point.getLatitude(),point.getLongitude());
        this.poly = poly;
    }
    // distance in meters from GLatLng point to GPolyline or GPolygon poly
    public boolean bdccGeoDistanceCheckWithRadius(int radius) {
        int i;
